...
class MdmFreemarkerGrailsPlugin extends Plugin {
    ...
    def title = "Mauro Data Mapper Freemarker Plugin"
    // Headline display name of the plugin
    def author = "James Welch"
    def authorEmail = "james.welch@bdi.ox.ac.uk"
    def description = '''\
The Apache Freemarker templating endpoints for the Mauro Data Mapper backend. 
'''
